...
function initialize() {
			...
			*/
			...
			var Y_point			= 37.5653161;		// Y 좌표
			var X_point			= 126.9745883;		// X 좌표

			var zoomLevel		= 15;						// 첫 로딩시 보일 지도의 확대 레벨

			var markerTitle		= "서울시청";				// 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
			...
			var contentString	= '<div id="content">' +
					...
					'<div id="bodyContent">'+ 
						'<p>서울시청입니다!. <br /><a href="http://www.seoul.go.kr" target="_blank">http://www.seoul.go.kr/</a></p>'+	
					'</div>'+ 
				'</div>';
